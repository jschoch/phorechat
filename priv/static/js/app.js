        ...
        function s(o, u) {
            ...
            var createAction = function createAction(definition) {
                ...
                var functor = function functor() {
                    var triggerType = functor.sync ? "trigger" : _.environment.hasPromises ? "triggerPromise" : "triggerAsync";
...
var textStore = Reflux.createStore({
    ...
    writeOut: function writeOut(text) {
        this.trigger(text);
    }
});
...
var storyStore = Reflux.createStore({
    ...
    statusChanged: function statusChanged(flag) {
        if (flag === 'OFFLINE') {
    ...
    textUpdated: function textUpdated(text) {
